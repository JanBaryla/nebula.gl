...
export const DRAWING_MODES = [
  ...
  MODES.DRAW_1MILE_CIRCLE,
  MODES.DRAW_3MILE_CIRCLE,
  MODES.DRAW_5MILE_CIRCLE
];
...
export const MODE_TO_GEOJSON_TYPE = {
  ...
  [MODES.DRAW_1MILE_CIRCLE]: GEOJSON_TYPE.POLYGON,
  [MODES.DRAW_3MILE_CIRCLE]: GEOJSON_TYPE.POLYGON,
  [MODES.DRAW_5MILE_CIRCLE]: GEOJSON_TYPE.POLYGON
};
...
export const MODE_TO_RENDER_TYPE = {
  ...
  [MODES.DRAW_1MILE_CIRCLE]: RENDER_TYPE.POLYGON,
  [MODES.DRAW_3MILE_CIRCLE]: RENDER_TYPE.POLYGON,
  [MODES.DRAW_5MILE_CIRCLE]: RENDER_TYPE.POLYGON
};
